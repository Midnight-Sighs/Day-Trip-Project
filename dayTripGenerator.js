...
//  As a user, I want to be able to randomly re-select a destinationNames, XXXrestaurant, XXXmode of transportation, and/or XXXform of entertainment if I don’t like one or more of those things.
...
//Sword Coast Data (SC) - X edit to sound better
let dataSC = {
...
function happyWithTrip(){
    alert(`You confirm that you are going to ${destinationNames} ${randomTrans} ${randomEnt} ${randomRest}.  We hope you enjoy your trip!  Do not forget to rate and review "Travel Fantasy" BEFORE your trip!`);
